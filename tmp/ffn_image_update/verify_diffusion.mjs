...
const source = "C:/docs/from_linear_regression_to_gpt/tmp/ffn_image_update/diffusion-normalized.pptx";
const out = "C:/docs/from_linear_regression_to_gpt/tmp/ffn_image_update/diffusion-verified";
